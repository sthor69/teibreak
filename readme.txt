 ...
 This will deploy two artifacts, target/webapp.war and
 default-ds.xml.
 ...
 Now you can either deploy the target/webapp.war through the
 web-based GlassFish admininstration console, or you can again use asadmin:

  ./asadmin deploy target/webapp.war

 To undeploy the application, run:

  ./asadmin undeploy webapp
